...
Published on the Docker Hub: <https://hub.docker.com/r/zjdaniels1985/activemq>

## Usage

```
docker run -it -p 61616:61616 -p 8161:8161 zjdaniels1985/activemq:latest
```
...
zjdaniels1985/activemq:latest
```

## ActiveMQ version

Current version of ActiveMQ is **5.18.1**: <https://archive.apache.org/dist/activemq/5.18.1/>
...
`git commit -m "Update ActiveMQ to 5.18.1"`

Then tag it.

`git tag -a v5.18.0 -m 'Release 5.18.1'`
...
```
docker tag <image> zjdaniels1985/activemq:5.18.1
docker push zjdaniels1985/activemq
```
